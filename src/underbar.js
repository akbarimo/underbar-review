(function() {
  ...
  _.shuffle = function(array) {
    ...
    var copy = [...array];
    while (copy.length > 0) {
      let currentIndex = Math.floor(Math.random() * copy.length);
      shuffledArray.push(copy[currentIndex]);
